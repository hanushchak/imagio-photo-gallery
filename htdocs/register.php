<!--
    ...
    Register page. To be used as alternative to modular sign up form.
-->
...
<head>
    ...
    ?>
    <title>Sign Up - imagio - Photo Gallery</title>
            ...
            <div class="flex_container">
                <div class="flex_content">
                    <form class="static_form">
                        ...
                        <?php include 'signup_input.php' ?>  <!-- this file contains signup input fields. Used on multiple pages and reduces code repetition -->
